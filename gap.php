        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Boost your career with Adobe Photoshop</h1><br>
                            <p class="desc">Expand your designer skill-set with photoshop ! You will learn to edit pictures and photos to create printable and digital designs! You will also use lightroom to ship the perfect and flawless photos.</p>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 details">9 Chapters</div>
                        <div class="col-lg-2 details">50 Exercice</div>
                        <div class="col-lg-2 details">6 Projects</div>
                        <div class="col-lg-2 details">4 Meetings</div>
                        <div class="col-lg-2 details">4 Workshops</div>
                    </div>
                    <br>
                    <div class="row" style="font-size: 15px; font-weight: 200; color: white;">
                        ...
                        <p><i class="fa fa-credit-card" style="padding-right: 8px;"></i>Price : 800 DT</p>
                    </div>
                </div>
                <div class="col-2 pt-5">
                    <img src="Images/gas.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">Introduction to Photoshop</td>
                            <td class="col-6">Get used to the software, and becoming familiar with its interface, how to navigate, and use very basic beginner tools.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">Understanding Typography</td>
                            <td class="col-6">Manipulating type in photoshop, applying different effects to type (for example internal and external shading, fabric effect,..)</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">Image Manipulation And Composition</td>
                            <td class="col-6">Learn one of the most important basics of Visual Communication: Composition, and how to take or pick a good photo. </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">Lightroom : Photographers Best Friend</td>
                            <td class="col-6">Learn to correct lights and balancing images to give them the ambiance you need using Lightroom..
                                </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="250">
                            ...
                            <td class="col-4 fw-bold">3D Forms and Photo Montage</td>
                            <td class="col-6">Get introduced to 3D forms and how to make a 2D Image have realistic depth and perspective.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300">
                            ...
                            <td class="col-4 fw-bold">
                                Digital Painting and Illustrations</td>
                            <td class="col-6">Learn to imitate oil paintings, to manipulate brushes and to mix modern and photographed objects with creative painted effects.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="350">
                            ...
                            <td class="col-4 fw-bold">Animation and Gifs</td>
                            <td class="col-6">Use Photoshop and Illustrator, By animating Illustrator assets or providing a source file of illustrator assets to use.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="400">
                            ...
                            <td class="col-4 fw-bold">
                                Professional and Freelancers Secrets</td>
                            <td class="col-6"> Freelancers Secrets
                                Learn what a creative brief contains and how to communicate with a client, what type of information we need to deliver a professional output to avoid excessive back and forth!</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class = "container">
            <div class = "row gy-lg-5 align-items-center">
                <div class = "col-lg-6 order-lg-1 text-center text-lg-start">
                    ...
                    <p data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Those who want to create their start-up and to launch an online store<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Those who are passionate about marketing.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Those who are passionate about marketing.</p>
                </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Master advanced Adobe Photoshop skills and Adobe Lightroom..<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Create digital and print graphic assets, Mockups and familiarize with their guidelines<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Learn compositions, layouts, patterns, and textures and know the importance of visual identity.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="Graphic Design : Adobe Photoshop" selected>Graphic Design : Adobe Photoshop</option>
