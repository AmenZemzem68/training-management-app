...
<html>
    ...
    <title>SEO and E-commerce</title>
        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Launch your career in Digital Marketing with SEO and e-commerce
                            </h1><br>
                            <p class="desc">Learn to launch your e-commerce and to boost your sales with wordpress and Woocommerce website !
                ...
                <div class="col-2 pt-5">
                    <img src="Images/seo.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">Search Engine Marketing (SEM)</td>
                            <td class="col-6">Understand what is search engine marketing
                                Understand the relationship between SEM, SEO, SEA, SMO</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">WordPress</td>
                            <td class="col-6">Create a full website that is attractive and user-friendly using a free content management system, WordPress.
                                Create an online store using Woocommerce..</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">Search Engine Optimization</td>
                            <td class="col-6">Gain an understanding of search engine algorithms and how they affect organic search results and websites</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">Search engine Advertising</td>
                            <td class="col-6">Learn about advertising opportunities within search engines, also called SEA and Google Display advertising.
                                </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="250">
                            ...
                            <td class="col-4 fw-bold">Social media optimization</td>
                            <td class="col-6">Discover 7 Simple Social Media for SEO Best Practices For Increasing SEO Rankings</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Create a WordPress and Woocommerce website.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i> Implement the SEO techniques to the website.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Create a complete Google Ad Campaign.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="SEO and E-commerce" selected>SEO and E-commerce</option>
                        </select>
                        </div>
