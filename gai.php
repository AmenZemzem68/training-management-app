...
<html>
    ...
    <title>Graphic Design : Adobe Illustrator</title>
        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Learn graphic desgin with Illustrator</h1><br>
                            <p class="desc">Learn how to use Adobe Illustrator and build logos, posters and other print visuals/deliverables using the creative process that will allow you to communicate visually.</p>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 details">9 Chapters</div>
                        <div class="col-lg-2 details">40 Exercice</div>
                        <div class="col-lg-2 details">15 Projects</div>
                    ...
                    <div class="row" style="font-size: 15px; font-weight: 200; color: white;">
                        ...
                        <p><i class="fa fa-credit-card" style="padding-right: 8px;"></i>Price : 600 DT</p>
                    </div>
                </div>
                <div class="col-2 pt-5">
                    <img src="Images/gaihero.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">Introduction to Graphic Design</td>
                            <td class="col-6">Discover what graphic design is, where it comes from, and why is it so important.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">Illustartor 101</td>
                            <td class="col-6">Discover what graphic design is, where it comes from, and why is it so important.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">Creative Process</td>
                            <td class="col-6">
                                Get introduced to the reality of projects and the steps to take in order for effective disciplined completion. </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">Typography</td>
                            <td class="col-6">Learn typography definition and keywords that any graphic designer must know.
                                </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="250">
                            ...
                            <td class="col-4 fw-bold">Colors</td>
                            <td class="col-6">Learn all about the color theory starting by the color wheel.
                                Learn how to choose a palette based on concrete rules and methods.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300">
                            ...
                            <td class="col-4 fw-bold">Shape and lines</td>
                            <td class="col-6">
                                Learn shapes , line and brushes in adobe illustrator.
                                
                                Learn basic drawing and tracing tools.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="350">
                            ...
                            <td class="col-4 fw-bold">Logos</td>
                            <td class="col-6">
                                Have a walkthrough on tracing a logo.
                                
                                Understand how to make a logo using the creative process.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="400">
                            ...
                            <td class="col-4 fw-bold">Portfolio on behance</td>
                            <td class="col-6">Create your account and set up your personal information.

                                Have a walkthrough on behance Interface and few project examples.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="450">
                            ...
                            <td class="col-4 fw-bold">Phase Lab</td>
                            <td class="col-6">
                                Discover the best practices, key takeaways, and tips to take into consideration when developing a project.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class = "container">
            <div class = "row gy-lg-5 align-items-center">
                <div class = "col-lg-6 order-lg-1 text-center text-lg-start">
                    ...
                    <p data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Students who wish to consolidate the skills they acquired at university or high school.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>People who are passionate about design.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>People who want to start a new career in graphic design.</p>
                </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Understand the Basics of Graphic Design.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Learn how to create a logo, a T-Shirt art, A poster…<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Understand how illustrator works and how vectors are created.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="Graphic Design : Adobe Illustrator" selected>Graphic Design : Adobe Illustrator</option>
