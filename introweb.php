        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Create your first website</h1><br>
                            <p class="desc">Learn the latest technologies to become a web developer and create websites with HTML, CSS. You will also learn the basics of JavaScript to make your pages interactive.</p>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 details">7 Chapters</div>
                        <div class="col-lg-2 details">100 Exercice</div>
                    ...
                    <div class="row" style="font-size: 15px; font-weight: 200; color: white;">
                        ...
                        <p><i class="fa fa-credit-card" style="padding-right: 8px;"></i>Price : 500 DT</p>
                    </div>
                </div>
                <div class="col-2 pt-5">
                    <img src="Images/iwhero.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">Introduction to Web Development</td>
                            <td class="col-6">Differentiate between “Internet” and “Web”.
                                Understand and summarize how the web work.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">HTML</td>
                            <td class="col-6">
                                Define HTML, the structuring of a web page, the tags.
                                Create web interfaces with HTML tags</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">CSS</td>
                            <td class="col-6">
                                Discover CSS.
                                Work with CSS selectors.
                                Add design to your website with CSS.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">CSS Layout</td>
                            <td class="col-6">Define positioning with CSS.
                        ...
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="250">
                            ...
                            <td class="col-4 fw-bold">JavaScript</td>
                            <td class="col-6">Define JavaScript.
                                Learn the basics of JavaScript.
                                Troubleshoot problems with JavaScript.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300">
                            ...
                            <td class="col-4 fw-bold">DOM</td>
                            <td class="col-6">Introducing DOM.
                                Manipulate HTML structures.
                                Create a dynamic website.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class = "row gy-lg-5 align-items-center">
                <div class = "col-lg-6 order-lg-1 text-center text-lg-start">
                    ...
                    <p data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>People aged 14 or older<br>
                        ...
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>People who want to get into web development</p>
                </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Learn to use HTML, CSS, and use HTML structures.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Understand and master the HTML / CSS color model.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Discover the role of JavaScript programming in web development.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="Intro Web Development" selected>Intro Web Development</option>
