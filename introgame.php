        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Create your Game</h1><br>
                            <p class="desc">Discover the world of video games, get started with Unity and C #, and practice solving simple problems with code.
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 details">83 Exercice</div>
                        <div class="col-lg-2 details">4 Projects</div>
                    ...
                    <div class="row" style="font-size: 15px; font-weight: 200; color: white;">
                        ...
                        <p><i class="fa fa-credit-card" style="padding-right: 8px;"></i>Price : 700 DT</p>
                    </div>
                </div>
                <div class="col-2 pt-5">
                    <img src="Images/ighero.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">Unity configuration interface</td>
                            <td class="col-6">Installing and configuring Unity
                                Discover the Unity3D game engine
                                Navigate in the Unity interface.
                                </td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">PONG</td>
                            <td class="col-6">
                                Discover the “Cloning Pong”.
                                Introduction to C # programming: variables, data types, the Unity Scripting API.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">Arkanoid</td>
                            <td class="col-6">Arkanoid cloning, C #: The “Destroy” function, layers and sorting layers, importing sprites.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">Flippy Bird</td>
                            <td class="col-6">Flappy Bird cloning, 2D animations and animator transitions, C #: New built-in functions: “AddForce”, “GetMouseButtonDown” etc.
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="250">
                            ...
                            <td class="col-4 fw-bold">Project Creation</td>
                            <td class="col-6">Advice for independent game developers, ideation process, creation of the final project.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class = "row gy-lg-5 align-items-center">
                <div class = "col-lg-6 order-lg-1 text-center text-lg-start">
                    ...
                    <p data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>People aged 14 or older<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Gaming and video game development enthusiasts.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>People who want to create their video games.</p>
                </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Learn about the development of video games.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Learn about the Unity3D game engine.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Become a video game developer and master the Unity3D game engine.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="2D Game Development" selected>2D Game Development</option>
