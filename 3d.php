        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Create your 3D Video Game
                            </h1><br>
                            <p class="desc">Become a video game developer and learn to create your game while modeling new characters in 3D thanks to Unity, one of the most powerful multimedia tools.
                            </p>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 details">8 Chapters</div>
                        <div class="col-lg-2 details">36 Exercice</div>
                ...
                <div class="col-2 pt-5">
                    <img src="Images/3dd.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">3D creation</td>
                            <td class="col-6">Learn about 3D space.

                                Manipulate 3D shapes, textures and light</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">"COLORBUMP”</td>
                            <td class="col-6">Create a ColorBump clone.

                                Mobile sweep controls.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">“First Person Shooter”</td>
                            <td class="col-6">Discover Unity “Asset Store” and free assets.

                                Create a first person shooter from scratch
                        ...
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                            ...
                            <td class="col-4 fw-bold">
                                Defense tower</td>
                            <td class="col-6">
                                Clone a Tower Defense game.
                                
                                Discover: “Pathfinding” and “NavMesh”.
                                
                                Discover simple artificial intelligence.
                                </td>
                        </tr>
        ...
        <div class = "container">
            <div class = "row gy-lg-5 align-items-center">
                <div class = "col-lg-6 order-lg-1 text-center text-lg-start">
                    ...
                    <p data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Gaming and video game development enthusiasts.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>For those over 18 years old.<br>
                        <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i> Motivation to follow the course.</p>
                </div>
            ...
            <div class = "container">
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-6 order-lg-0 text-center text-lg-start">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"><i class="fa fa-arrow-right" style="padding-right: 10px;"></i>Use advanced 2D physics components.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Create your own video game.<br>
                            <i class="fa fa-arrow-right" aria-hidden="true" style="padding-right: 10px;"></i>Use 2D light.</p>
                    </div>
            ...
            <div class = "container">
                ...
                <div class = "row gy-lg-5 align-items-center">
                    <div class = "col-lg-12 text-center text-lg-start" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                        ...
                        <option value="3D Game Development" selected>3D Game Development</option>
