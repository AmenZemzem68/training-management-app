        ...
        <header id = "head" class = "vh-100">
            ...
            <div class = "container row" id="head2" style="padding-top: 170px;" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                <div class="col-8 px-5">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 style="color: white;">Create your 2D Video Game
                            </h1><br>
                            <p class="desc">A more advanced course to create your own "free-to-play" video game by mastering Unity and C #
                            </p>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 details">3 Chapters</div>
                        <div class="col-lg-2 details">26 Exercice</div>
                ...
                <div class="col-2 pt-5">
                    <img src="Images/2dd.jpg" style="width: 500px; height: 300px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                </div>
            </div>
        </header>
    <!-- end of header -->
                ...
                <table class="table" style="border: 10px;">
                    <tbody>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="50">
                            ...
                            <td class="col-4 fw-bold">2D platformer</td>
                            <td class="col-6">Create a 2D platform game.
                                C #: Save data from players, Coroutines and public functions.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
                            ...
                            <td class="col-4 fw-bold ">SHOOTER TOP DOWN 2D</td>
                            <td class="col-6"> DOWN 2D
                                Create a 2D Top Down shooter with Unity.
                                
                                Use C #: Instantiating objects, arrays and loops and calling functions.</td>
                        </tr>
                        <tr class="row py-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="150">
                            ...
                            <td class="col-4 fw-bold">Additional tips</td>
                            <td class="col-6">
                                Learn tips on scene management, user interface, and 2D physics</td>
                    </tbody>
                </table>
            </div>
        </div>
